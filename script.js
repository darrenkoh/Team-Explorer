    ...
    function update() {
        ...
        link.merge(linkEnter)
            .attr("stroke", function (d) {
                console.log("Link from", d.source.data.name, "to", d.target.data.name,
                    "edgeColor:", d.source.data.edgeColor);
                return d.source.data.edgeColor || "#ccc";
            })
            .attr("stroke-width", function (d) {
                console.log("Link from", d.source.data.name, "to", d.target.data.name,
                    "edgeWidth:", d.source.data.edgeWidth);
                return d.source.data.edgeWidth || 2;
            });
        // Update nodes
